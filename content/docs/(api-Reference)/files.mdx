...
|-----|----|----|
|400 Bad Request  |	"No file uploaded"|	No file was included in the request.|
...
|415 Unsupported Media Type |	"Invalid file format"|	The uploaded file is in an unsupported format.|
